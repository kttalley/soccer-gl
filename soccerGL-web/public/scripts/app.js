...
var renderTemplate = function renderTemplate() {
    ...
    var canv1 = function canv1(soccer) {
        ...
        var instSoccer = function instSoccer() {
            soccerBall.updte();
            soccerBall.draw();
        };

        soccer.draw = function () {
